...
MainFrame.BackgroundColor3 = Color3.fromRGB(70, 70, 70) -- Gray background
...
GetKeyButton.BackgroundColor3 = Color3.fromRGB(70, 130, 255) -- Blue color
...
InfoText.Position = UDim2.new(0, 25, 0, 240)
...
-- Discord button (bottom left) with icon and text
local DiscordButton = Instance.new("TextButton")
DiscordButton.Name = "DiscordButton"
DiscordButton.Size = UDim2.new(0, 80, 0, 30)
DiscordButton.Position = UDim2.new(0, 15, 1, -40)
...
DiscordIcon.Position = UDim2.new(0, 8, 0, 7)
...
DiscordText.Size = UDim2.new(1, -28, 1, 0)
...
-- Website button (bottom left, next to Discord) with icon and text
local WebsiteButton = Instance.new("TextButton")
WebsiteButton.Name = "WebsiteButton"
WebsiteButton.Size = UDim2.new(0, 80, 0, 30)
WebsiteButton.Position = UDim2.new(0, 105, 1, -40)
...
WebsiteIcon.Size = UDim2.new(0, 16, 0, 16)
WebsiteIcon.Position = UDim2.new(0, 8, 0, 7)
WebsiteIcon.BackgroundTransparency = 1
WebsiteIcon.Image = "rbxassetid://3926305904" -- Website icon
WebsiteIcon.ImageColor3 = Color3.fromRGB(255, 255, 255)
WebsiteIcon.Parent = WebsiteButton

-- Website text
local WebsiteText = Instance.new("TextLabel")
WebsiteText.Name = "WebsiteText"
WebsiteText.Size = UDim2.new(1, -28, 1, 0)
WebsiteText.Position = UDim2.new(0, 28, 0, 0)
WebsiteText.BackgroundTransparency = 1
WebsiteText.Text = "Website"
WebsiteText.TextColor3 = Color3.fromRGB(255, 255, 255)
WebsiteText.Font = Enum.Font.Gotham
WebsiteText.TextSize = 11
WebsiteText.TextXAlignment = Enum.TextXAlignment.Left
WebsiteText.Parent = WebsiteButton
...
createHoverEffect(GetKeyButton, Color3.fromRGB(90, 150, 255), Color3.fromRGB(70, 130, 255))
